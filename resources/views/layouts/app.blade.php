...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-4 col-md-4">
                    <div class="logo">
                        <a href="#"><img src="{{ asset('images/tecsup.png') }}"></a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="menu">
                        ...
                        <li><a href="{{ route('book_issued') }}">Prestamos</a></li>
                        <li><a href="{{ route('reports') }}">Reportes</a></li>
                        <li><a href="{{ route('settings') }}">Ajustes</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <span>© Copyright 2023 <a href="https://www.tecsup.edu.pe/">TECSUP</a></span>
                </div>
            </div>
        </div>
    </div>
